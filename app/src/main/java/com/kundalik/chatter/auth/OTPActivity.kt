...
import com.kundalik.chatter.databinding.ActivityOtpactivityBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val option = PhoneAuthOptions.newBuilder(auth)
            ...
            .setCallbacks(object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                ...
                override fun onVerificationFailed(p0: FirebaseException) {
                    dialog.dismiss()
                    Toast.makeText(this@OTPActivity, "Please Try Again ${p0.message}", Toast.LENGTH_LONG).show()
                }
        ...
        binding.btnOtpContinue.setOnClickListener {
            ...
            if (binding.etOtp.text!!.isEmpty()) {
                ...
                dialog.show()
                val credential =
                    PhoneAuthProvider.getCredential(verificationId, binding.etOtp.text!!.toString())
